      ...
      await sheets.spreadsheets.values.append({
        ...
        requestBody: {
          values: [
            ...
            ['TITLE', '일본어 타이틀 재번역 + UpdateGoods 호출 (갱신 필드 전체: ItemTitle / SecondSubCat / ItemPrice / RetailPrice / ItemQty / AvailableDateType / AvailableDateValue / ShippingNo / AdultYN / TaxRate / ExpireDate / StandardImage / Weight / PromotionName / ProductionPlaceType / ProductionPlace / IndustrialCodeType / IndustrialCode)', 'OpenRouter + Qoo10 UpdateGoods', '유료'],
