...
### qsm 인기 키워드 데이터 갱신 시각

qsm 측 일배치는 매일 **00:31 ~ 02:10 KST 사이**에 "어제" 컬럼을 일괄 갱신한다 (2026-05-05 측정, 1h 39min 윈도우). 09:00 cron은 갱신 후 약 7시간 여유 — 항상 최신 전일 데이터 확보. 02:10 이후라면 어느 시점에 fetch해도 당일 새 데이터 보장.
